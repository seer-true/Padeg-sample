object Form1: TForm1
  ...
  object grpFIO: TGroupBox
    ...
    object cbFIO: TComboBox
      ...
      Items.Strings = (
        ...
        #1063#1077#1088#1085#1099'-'#1057#1090#1077#1092#1072#1085#1100#1089#1082#1072' '#1043#1072#1083#1080#1085#1072' '#1057#1090#1072#1085#1080#1089#1083#1072#1074#1086#1074#1085#1072
  ...
  object grpOffice: TGroupBox
    ...
    object cbAppointment: TComboBox
      Left = 96
      Top = 16
      Width = 241
      Height = 21
    ...
    object btnDeclApp: TButton
      ...
      Caption = #1057#1082#1083#1086#1085#1103#1090#1100
      TabOrder = 2
      OnClick = btnDeclAppClick
    end
    object btnDeclOff: TButton
      Left = 262
      Top = 97
      Width = 75
      Height = 25
    ...
    object btnNewDict: TButton
      ...
      Width = 120
      Height = 25
      Caption = #1053#1086#1074#1099#1081' '#1089#1083#1086#1074#1072#1088#1100
      TabOrder = 4
      OnClick = btnNewDictClick
    end
    object btnLoadChange: TButton
      Left = 217
      Top = 147
      Width = 120
      Height = 25
      Caption = #1047#1072#1075#1088#1091#1079#1080#1090#1100' '#1080#1079#1084#1077#1085#1077#1085#1080#1103
      TabOrder = 5
      OnClick = btnLoadChangeClick
    end
    object btnApp_Off: TButton
      Left = 6
      Top = 101
      Width = 179
      Height = 25
      Caption = #1044#1086#1083#1078#1085#1086#1089#1090#1100'+'#1087#1086#1076#1088#1072#1079#1076#1077#1083#1077#1085#1080#1077
      TabOrder = 6
      OnClick = btnApp_OffClick
    end
  end
