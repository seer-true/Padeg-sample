  ...
  object pgcTop: TPageControl
    ...
    object tsFIO: TTabSheet
      ...
      object eFIO: TComboBox
        ...
        ParentFont = False
        TabOrder = 10
        Text = #1050#1083#1080#1085#1094#1077#1074' '#1042#1080#1082#1090#1086#1088' '#1043#1088#1080#1075#1086#1088#1100#1077#1074#1080#1095'         '
        OnSelect = eFIOSelect
        Items.Strings = (
    ...
    object tsOffice: TTabSheet
      ...
      object eAppointment: TComboBox
        ...
        ParentFont = False
        TabOrder = 3
        Text = #1053#1072#1095#1072#1083#1100#1085#1080#1082' '#1087#1088'-'#1074#1072
        ...
        Items.Strings = (
          ...
          #1043#1083#1072#1074#1085#1099#1081' '#1080#1085#1078'. '#1040#1074#1090#1086#1042#1040#1047
          ...
          #1050#1072#1087#1080#1090#1072#1085'-'#1083#1077#1081#1090#1080#1085#1072#1085#1090
      ...
      object eOffice: TComboBox
        ...
        ParentFont = False
        TabOrder = 4
        Text = #1048#1085#1089#1090#1088#1091#1084#1077#1085#1072#1083#1100#1085#1086#1077' '#1087#1088'-'#1074#1086
        Items.Strings = (
